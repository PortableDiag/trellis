                ...
                egui::ScrollArea::vertical()
                    ...
                    ui.collapsing("Endpoints", |ui| {
                        ...
                        "         a bare [[Title]] resolves to the linking card's own project first, then the lowest node id (stable across runs)",
                            ...
                            "GET    /api/cards/{cid}/images   (what this card carries: names + sizes, never bytes; inline body images listed separately)  ·  POST /api/cards/{cid}/images {data_base64}  ·  GET …/images/{idx}  ·  DELETE …/images/{idx}",
                            ...
                            "GET    /api/nodes/{id}/cards/{cid}/images  (names + sizes)  ·  GET …/images/{idx}  ·  DELETE …/images/{idx}",
